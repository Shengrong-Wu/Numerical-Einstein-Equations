"""Self-contained data and continuation helpers for Experiment 6B.

This module contains only analytic boundary formulas, coordinate maps, and
the exact-prefix prolongation rule. It has no dependency on another project
or on a numerical result artifact.
"""
...
class TrappedSectionParameters:
    """Physical and coordinate parameters for Experiment 6B."""
