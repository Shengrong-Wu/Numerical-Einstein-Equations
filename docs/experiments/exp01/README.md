...
Every case records exact metric closures, fresh first-order null residuals,
an independently reconstructed four-metric Ricci tensor, and a deliberately
...
so the exact metric/closure comparison—not a small aggregate residual alone—is
